...
static unsigned int stb__G_Running_adler;
...
#define STB__TRY(t, p) /* avoid retrying a match we already tried */ \
    ...
    *pending_literals = (int)(q - lit_start);
    ...
    stb__G_Running_adler = stb_adler32(stb__G_Running_adler, start, (stb_uint)(q - start));
    return (int)(q - start);
}
